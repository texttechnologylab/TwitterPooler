...
//@QuarkusTest
public class LikeLkpTest {
    @Inject
    @MongoClientName("tweets")
    MongoClient mongoClientTweets;
    @Test
    public void likedTest() throws URISyntaxException, IOException {
        /*String userId = "1293622780030844940";
        String endpointKey = "liked";
        ...
        //create uri
        URIBuilder uri = query.createLikedQuery(endpointClass.getEndp(),query.getUserId(),"10");
    ...
    @Test
    public void likingTest() throws URISyntaxException, IOException {
        /*String tweetId = "1454678518969864200";
        String endpointKey = "liking";
        ...
        //create uri
        URIBuilder uri = query.createLikingQuery(endpointClass.getEndp(),query.getTweetId());
