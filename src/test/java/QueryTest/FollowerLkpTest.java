...
//@QuarkusTest
public class FollowerLkpTest {
    @Inject
    @MongoClientName("tweets")
    MongoClient mongoClientTweets;

    @Test
    public void followersTest() throws URISyntaxException, IOException {
        /*String userId = "1293622780030844940";
        String endpointKey = "followersByUserId";
        ...
        //create uri
        URIBuilder uri = query.createFollowersQuery(endpointClass.getEndp(),query.getUserId(),"10");
